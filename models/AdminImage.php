<?php
    class AdminImage extends Omeka_Record_AbstractRecord
    {
        ...
        /*
         *@var string The URL for the image to link to
         */
        public $href;

        /*
         *@var int The id of the file associated with the image
         */
        public $file_id;
        ...
        public function getUsername() {
            return get_db()->getTable('User')->find($this->creator_id)['name'];
        }
        ...
        public function linkToImage($size="thumbnail") {
            ...
            return '<a href="' . $href . '" target="_blank"><img' . $title . $alt . ' src="' . $this->getUrl($size) . '"></a>';
        }
        ...
        public static function CreateImage(){
            ...
            $image->save();
            return __('File successfully processed.');
        }
